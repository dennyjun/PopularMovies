...
/**
 * Template provided in Sunshine app
 *
...
public class SettingsActivity extends PreferenceActivity
    ...
    /**
     * src: http://stackoverflow.com/questions/26509180/no-actionbar-in-preferenceactivity-after-upgrade-to-support-library-v21
     */
    private void addToolbarToTop() {
        final LinearLayout root =
                (LinearLayout)findViewById(android.R.id.list).getParent().getParent().getParent();
        final Toolbar bar = (Toolbar) LayoutInflater.from(this)
